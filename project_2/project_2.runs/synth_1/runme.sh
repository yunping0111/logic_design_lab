...
HD_PWD='C:/Users/penny/OneDrive/Desktop/logic design lab/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_4x1_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_4x1_4bit.tcl

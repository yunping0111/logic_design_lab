...
HD_PWD='C:/Users/penny/OneDrive/Desktop/logic design lab/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_4x1_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux_4x1_4bit.tcl -notrace
